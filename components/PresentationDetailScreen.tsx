        ...
        <div className="max-w-7xl mx-auto px-4 py-6 h-screen flex flex-col relative z-10">
            ...
            <div className="flex-grow relative animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                ...
                <div className="absolute inset-0 bg-[#0a0a0a] rounded-xl border border-white/10 overflow-hidden shadow-2xl flex flex-col">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 bg-[#050505] -z-10">
                        ...
                        <h3 className="text-white font-display text-xl mb-4 uppercase">Náhled se nenačítá?</h3>
