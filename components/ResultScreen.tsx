  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-6 min-h-screen flex flex-col items-center justify-center text-center relative z-10">
      ...
      <div className="relative w-full transition-all duration-500 animate-fade-in-up">
        ...
        <div className="glass-panel w-full p-6 md:p-10 rounded-2xl md:rounded-3xl border border-gray-200 dark:border-white/10 relative overflow-hidden bg-white/90 dark:bg-[#050505]/90 backdrop-blur-2xl">
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div className={`w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gray-50 dark:bg-black/50 border ${borderColor} flex items-center justify-center mb-6 md:mb-8 shadow-[0_0_30px_rgba(0,0,0,0.3)]`}>
            ...
            <h1 className={`text-2xl md:text-5xl font-display font-bold text-gray-900 dark:text-white mb-3 md:mb-4 uppercase`}>{title}</h1>
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-8 md:mb-10 max-w-md leading-relaxed">
              {message}
            </p>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4 w-full mb-6 md:mb-8">
              <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/5 rounded-xl p-3 md:p-4">
                <div className="text-gray-500 text-[10px] md:text-xs uppercase tracking-wider mb-1 font-mono">Správně</div>
                <div className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white font-mono">{score}</div>
              </div>
              <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/5 rounded-xl p-3 md:p-4">
                <div className="text-gray-500 text-[10px] md:text-xs uppercase tracking-wider mb-1 font-mono">Celkem</div>
                <div className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white font-mono">{totalQuestions}</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full">
              <button
                onClick={onRestart}
                className="flex-1 bg-gray-900 dark:bg-white text-white dark:text-black hover:bg-black dark:hover:bg-cyan-50 py-3 md:py-4 rounded-full font-bold text-xs md:text-sm tracking-wide transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:shadow-[0_0_30px_rgba(6,182,212,0.4)] flex items-center justify-center gap-2 font-display uppercase"
              >
                <RotateCcw className="w-4 h-4" /> OPAKOVAT TEST
              </button>
              <button
                onClick={onBackToMenu}
                className="flex-1 bg-transparent hover:bg-gray-100 dark:hover:bg-white/5 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-white/20 py-3 md:py-4 rounded-full font-bold text-xs md:text-sm tracking-wide transition-all flex items-center justify-center gap-2 font-display uppercase"
              >
